...
class StegoLoss(BaseLoss):
    def __init__(self, config) -> None:
        ...
        # Three weights scale the contribution of three correspondence types:
        # self (same-pixel/self-correspondence),
        # knn (nearest-neighbor across space/time/views),
        # random (random negatives/baselines).
         
        # Three shifts act like margins/bias terms in the loss for each correspondence type.

        # pointwise=True enables a per-row mean-centering step on teacher correlations (details below).
